# To detect or analyze text in a multipage pdf document
# and store the json results on s3 bucket.
#
# Article:
# @url https://medium.com/p/827c6e866453/edit
#
# Credits:
...
class DocumentProcessor:
    ...
    def main(self, bucketName, documentName):
        self.roleArn = 'arn:aws:iam::644408420609:role/service-role/python-textract-example-role-1luchb7i'
        # self.bucket = 'textract-analysis-example'
        # self.document = 'balancete-2pages.pdf'
    ...
    def StoreInS3(self, response):
        ...
        pdfTextExtractionS3Bucket = 'textract-analysis-example'
